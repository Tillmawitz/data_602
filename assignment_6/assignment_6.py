...
def exercise01():
    ...
    df1 = pd.DataFrame({'Name': ["John", "Luke", "Han", "Tina", "Leia"], "Age": [36, 22, 34, 21, 19]})
...
def exercise04():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    dicts = [{'city': 'New York', 'data': 'Cool'}, {'city': 'Boise', 'data': 'Lame'}, {'city': 'Denver', 'data': 'Okay'}]
    df4 = pd.DataFrame.from_dict(dicts)
    # ------ Place code above here /\ /\ /\ ------
    return df4
...
def exercise05(df):
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    # This solution was already here?
